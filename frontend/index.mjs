...
import "/framework/js/xhr.mjs";
import "/framework/js/util.mjs";
import "/framework/js/session.mjs";
import "/framework/js/securityguard.mjs";
import "/framework/js/router.mjs";
import "/framework/js/pwasupport.mjs";
import "/framework/js/monkshu_component.mjs";
import "/framework/js/log.mjs";
import "/framework/js/loadbalancer.mjs";
import "/framework/js/index.mjs";
import "/framework/js/i18n.mjs";
import "/framework/js/constants.mjs";
import "/framework/js/cacheworker.mjs";
import "/framework/js/bootstrap.mjs";
import "/framework/js/blackboard.mjs";
import "/framework/js/apimanager.mjs";
import "/framework/components/page-generator/page-generator.mjs";
import "/framework/components/html-fragment/html-fragment.mjs";
import "/framework/3p/pako.esm.min.mjs";
import "/apps/neuranet/views/search/js/main.mjs";
import "/apps/neuranet/views/enterpriseassist/js/main.mjs";
import "/apps/neuranet/views/chooser/js/main.mjs";
import "/apps/neuranet/views/chat/js/main.mjs";
import "/apps/neuranet/views/aiworkshop/js/main.mjs";
import "/apps/neuranet/js/neuranetapp.mjs";
import "/apps/neuranet/js/main.mjs";
import "/apps/neuranet/js/loginmanager.mjs";
import "/apps/neuranet/js/language.mjs";
import "/apps/neuranet/js/constants.mjs";
import "/apps/neuranet/js/application.mjs";
import "/apps/neuranet/i18n/i18n_ja.mjs";
import "/apps/neuranet/i18n/i18n_hi.mjs";
import "/apps/neuranet/i18n/i18n_en.mjs";
import "/apps/neuranet/components/span-with-menu/span-with-menu.mjs";
import "/apps/neuranet/components/file-manager/file-manager.mjs";
import "/apps/neuranet/components/file-manager/i18n/i18n_ja.mjs";
import "/apps/neuranet/components/file-manager/i18n/i18n_hi.mjs";
import "/apps/neuranet/components/file-manager/i18n/i18n_en.mjs";
import "/apps/neuranet/components/dialog-box/dialog-box.mjs";
import "/apps/neuranet/components/chat-box/chat-box.mjs";
import "/apps/neuranet/components/chat-box/3p/katex-0.16.min.mjs";
import "/apps/neuranet/components/bread-crumbs/bread-crumbs.mjs";
import "/apps/neuranet/3p/tkmlogin.mjs";
